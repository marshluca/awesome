...
task :defaults do
  ...
  set_default :shared_paths,    ['config/database.yml', 'config/unicorn.rb', 'tmp', 'log', 'public/system'] # last one is for paperclip
  ...
  set_default :god_sidekiq,     "#{config_path}/god/sidekiq.god"
  set_default :god_thin,     "#{config_path}/god/thin.god"
